...
class HomeSplash extends React.Component {
  render() {
    ...
    return (
      <SplashContainer>
        <Logo img_src={`${baseUrl}img/illu-home.png`} />
        <div className="inner">
          <ProjectTitle siteConfig={siteConfig} />
          <PromoSection>
            <Button href="https://baas.skillz.io">Try BaaS</Button>
            <Button href={docUrl('global_understanding.html')}>Documentation</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
