...
const siteConfig = {
  ...
  headerLinks: [
    {doc: 'global_understanding', label: 'Docs'},
    // {doc: 'api', label: 'API'},
  ...
  headerIcon: 'img/baas.png',
  footerIcon: 'img/baas.png',
  favicon: 'img/baas.png',

  /* Colors for website */
  colors: {
    primaryColor: '#242c43',
    secondaryColor: '#3E55FF',
  },
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} SkillZ`,
  ...
  // template. For example, if you need your repo's URL...
     repoUrl: 'https://github.com/skillz-blockchain/volt_entity',
};
